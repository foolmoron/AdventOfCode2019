...
//             switch(step[0]) {
//             case 'L':
//                 vec = [-parseInt('N555'.substr(1)), 0];
//                 break;
//             case 'R':
//                 vec = [parseInt('N555'.substr(1)), 0];
//                 break;
//             case 'U':
//                 vec = [0, parseInt('N555'.substr(1))];
//                 break;
//             case 'D':
//                 vec = [0 -parseInt('N555'.substr(1))];
//                 break;
//             }
//             steps.push([steps[i][0] + vec[0], steps[i][1] + vec[1]]);
//         }
//         return steps;
//     });
...
//         const s1 = segments[0][i];
//         const s2 = segments[1][i];
//         const int = intersection(s1, s2);
//         if (int) {
//             ints.push(int)
//         }
//     }
